...
class MyVQC(VQAlgorithm):
    ...
    def construct_circuit(self, x, theta, measurement=False):
        ...
        if isinstance(self.var_form, QuantumCircuit):
            ...
            try:
                qc += self._var_form.construct_circuit(x_v, theta, qr)
            except TypeError:
    ...
    def _compute_dispersion(self, theta):
        num_qubit = self._var_form._num_dis
#         vectors = []
